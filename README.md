...
Format: curl --data-binary @ -d 'tokenizer=<stem | lemma>&n_gram=<1-gram |2-gram | 3-gram>&threshold_factor=\<float\>' #<span>https&#58;//summarizer-lopasso&#46;herokuapp&#46;&#8203;com/predict</span>
